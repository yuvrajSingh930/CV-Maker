...
public class GenerateCV {
    ...
    //Education
    public static String Institute,Institute1,Institute2,PassYear,PassYear1,PassYear2,Grade,Grade1,Grade2,Course,Course1,Course2,Research,Research1,Research2;
    ...
    public static void main( String[] args ) throws  IOException
    {
        HTML = "<html>\r\n" +
                ...
                "<p style=\"margin-bottom: 0px;margin-top: 0px\">&nbsp; &nbsp;Course: "+Course+"<br />&nbsp; &nbsp;Passing Year: "+ PassYear+"<br />&nbsp; &nbsp;Grade: "+Grade+"<br />&nbsp; &nbsp;Research: "+Research+"</p>\r\n" +
                "</li>\r\n" +
                "<li><strong>"+Institute1+"</strong>\r\n" +
                "<p style=\"margin-bottom: 0px;margin-top: 0px\">&nbsp; &nbsp;Course: "+Course1+"<br />&nbsp; &nbsp;Passing Year: "+ PassYear1+"<br />&nbsp; &nbsp;Grade: "+Grade1+"<br />&nbsp; &nbsp;Research: "+Research1+"</p>\r\n" +
                "</li>\r\n" +
                "<li><strong>"+Institute2+"</strong>\r\n" +
                "<p style=\"margin-bottom: 0px;margin-top: 0px\">&nbsp; &nbsp;Course: "+Course2+"<br />&nbsp; &nbsp;Passing Year: "+ PassYear2+"<br />&nbsp; &nbsp;Grade: "+Grade2+"<br />&nbsp; &nbsp;Research: "+Research2+"</p>\r\n" +
                "</li>\r\n" +
                "</ul>\r\n" +
                "\r\n" +
                "\r\n" +
