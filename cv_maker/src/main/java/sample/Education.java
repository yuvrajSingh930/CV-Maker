...
public class Education implements Initializable {
    ...
    @FXML
    private TextField Research1;

    @FXML
    private TextField Research2;
    ...
    public void saveButton(ActionEvent event) throws IOException {
        ...
        GenerateCV.Research = Research.getText();
        GenerateCV.Research1 = Research1.getText();
        GenerateCV.Research2 = Research2.getText();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Research.setText(GenerateCV.Research);
        Research1.setText(GenerateCV.Research1);
        Research2.setText(GenerateCV.Research2);
